...
/*12*/
delimiter //
CREATE FUNCTION produOrder(fechaInicio DATE, fechaFin DATE, codeprodu TEXT) RETURNS FLOAT deterministic
BEGIN
...
END//
delimiter ;
DROP FUNCTION produOrder;

select produOrder("2003-01-01", "2003-01-04", "S18_1749");


/*14*/
delimiter //
CREATE FUNCTION reporta() RETURNS TEXT DETERMINISTIC
BEGIN
